...
help:
	...
	@echo "                     INFERENCE=<alg> (importance-sampling, mcmc-mh, mcmc-hmc, mcmc-blocked)"
	...
	@echo "  make train FILE=examples/c_programs/simple.c DATA=measurements/segments.csv INFERENCE=mcmc-mh"
