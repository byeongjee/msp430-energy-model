...
/Users/byeongjee/migration/probabilistic-energy-modeling/build/test_rlc_cleaned.elf:     file format elf32-msp430
...
0000400c <__crt0_call_exit>:
    400c:	b0 12 4c 42 	call	#16972		;#0x424c
...
000041ae <initialize>:
    ...
    41c8:	3d 40 4e 42 	mov	#16974,	r13	;#0x424e
...
0000422c <main>:
    ...
    4230:	3c 40 00 80 	mov	#-32768,r12	;#0x8000
    4234:	12 d3       	setc			
    4236:	0c 6c       	rlc	r12		;
    4238:	30 41       	ret			

0000423a <memcpy>:
    423a:	0f 4c       	mov	r12,	r15	;
    423c:	0e 5d       	add	r13,	r14	;
    423e:	0d 9e       	cmp	r14,	r13	;
    4240:	01 20       	jnz	$+4      	;abs 0x4244
    4242:	30 41       	ret			
    4244:	ff 4d 00 00 	mov.b	@r13+,	0(r15)	;
    4248:	1f 53       	inc	r15		;
    424a:	f9 3f       	jmp	$-12     	;abs 0x423e

0000424c <_exit>:
    424c:	ff 3f       	jmp	$+0      	;abs 0x424c
