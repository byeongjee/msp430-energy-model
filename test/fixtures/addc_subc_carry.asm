...
/Users/byeongjee/migration/probabilistic-energy-modeling/build/addc_subc_carry_cleaned.elf:     file format elf32-msp430
...
0000401e <main>:
    ...
    4020:	12 d3       	setc			
    4022:	35 43       	mov	#-1,	r5	;r3 As==11
    4024:	05 63       	adc	r5		;
    4026:	04 2c       	jc	$+10     	;abs 0x4030
    4028:	b2 40 ef be 	mov	#-16657,&0x1c02	;#0xbeef
    402c:	02 1c 
    402e:	03 3c       	jmp	$+8      	;abs 0x4036

00004030 <addc_carry_set>:
    4030:	b2 40 fe ca 	mov	#-13570,&0x1c02	;#0xcafe
    4034:	02 1c 

00004036 <addc_done>:
    4036:	12 c3       	clrc			
    4038:	15 43       	mov	#1,	r5	;r3 As==01
    403a:	15 73       	subc	#1,	r5	;r3 As==01
    403c:	04 28       	jnc	$+10     	;abs 0x4046
    403e:	b2 40 ef be 	mov	#-16657,&0x1c00	;#0xbeef
    4042:	00 1c 
    4044:	03 3c       	jmp	$+8      	;abs 0x404c

00004046 <subc_no_carry>:
