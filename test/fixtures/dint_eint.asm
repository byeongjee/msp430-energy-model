...
0000400c <__crt0_call_exit>:
    400c:	b0 12 54 42 	call	#16980		;#0x4254
...
000041ae <initialize>:
    ...
    41c8:	3d 40 56 42 	mov	#16982,	r13	;#0x4256
    41cc:	b0 12 42 42 	call	#16962		;#0x4242
...
00004230 <main>:
    4230:	b0 12 ae 41 	call	#16814		;#0x41ae
    4234:	03 43       	nop			
    4236:	32 d2       	eint			
    4238:	03 43       	nop			
    423a:	32 c2       	dint			
    423c:	03 43       	nop			
    423e:	4c 43       	clr.b	r12		;
    4240:	30 41       	ret			

00004242 <memcpy>:
    4242:	0f 4c       	mov	r12,	r15	;
    4244:	0e 5d       	add	r13,	r14	;
    4246:	0d 9e       	cmp	r14,	r13	;
    4248:	01 20       	jnz	$+4      	;abs 0x424c
    424a:	30 41       	ret			
    424c:	ff 4d 00 00 	mov.b	@r13+,	0(r15)	;
    4250:	1f 53       	inc	r15		;
    4252:	f9 3f       	jmp	$-12     	;abs 0x4246

00004254 <_exit>:
    4254:	ff 3f       	jmp	$+0      	;abs 0x4254
