...
/Users/byeongjee/migration/probabilistic-energy-modeling/build/test_rpt.elf:     file format elf32-msp430
...
0000400c <__crt0_call_exit>:
    400c:	b0 12 78 41 	call	#16760		;#0x4178
...
0000415e <.LCFI0>:
    415e:	b0 12 02 41 	call	#16642		;#0x4102

00004162 <.Loc.8.2>:
    4162:	b1 40 00 f0 	mov	#-4096,	0(r1)	;#0xf000
    4166:	00 00 

00004168 <.Loc.12.2>:
    4168:	2c 41       	mov	@r1,	r12	;
    416a:	42 18 0c 11 	rpt #3 { rrax.w	r12		;
    416e:	81 4c 00 00 	mov	r12,	0(r1)	;

00004172 <.Loc.20.2>:
    4172:	2c 41       	mov	@r1,	r12	;
