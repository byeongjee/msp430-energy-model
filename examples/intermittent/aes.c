...
struct AES_ctx g_ctx SRAM_BSS;

static uint8_t g_key[16] __attribute__((used)) SRAM_DATA = {
    0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c};

static uint8_t g_iv[16] __attribute__((used)) SRAM_DATA = {
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f};

uint8_t g_buf[AES_BUFFER_LEN] SRAM_BSS;

/* --- Const data (no annotation) --- */

static const uint8_t sbox[256] SRAM_RODATA = {
...
static const uint8_t rsbox[256] SRAM_RODATA = {
...
static const uint8_t Rcon[11] SRAM_RODATA = {0x8d, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36};
...
static const uint8_t test_data[AES_BUFFER_LEN] SRAM_RODATA = {
    AES_TEST_VECTOR_64,
    AES_TEST_VECTOR_64,
    AES_TEST_VECTOR_64,
    AES_TEST_VECTOR_64,
