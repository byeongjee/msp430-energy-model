...
function execute!(
    ...
    return execute_dual_operand!(state, MOVA_CONFIG, inst, ops, data_size, should_track_memory_access)
end
...
function execute!(
    ...
    return execute_dual_operand!(state, ADDA_CONFIG, inst, ops, data_size, should_track_memory_access)
end
...
function execute!(
    ...
    return execute_dual_operand!(state, DADD_CONFIG, inst, ops, data_size, should_track_memory_access)
end
...
function execute!(
    ...
    return execute_single_operand_rmw!(
        state, :rrax, inst, ops, data_size, should_track_memory_access
    ) do state, operand_val, data_size
...
function execute!(
    ...
    return execute_single_operand_rmw!(
        state, :rla, inst, ops, data_size, should_track_memory_access
    ) do state, operand_val, data_size
...
function execute!(
    ...
    return execute_single_operand_rmw!(
        state, :rlax, inst, ops, data_size, should_track_memory_access
    ) do state, dst_val, data_size
