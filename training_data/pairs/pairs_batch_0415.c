...
INLINE void bench_cmp_symbolic_register__cmp_indirect_absolute(void) {
  uint16_t dst = 0x1234;
...
INLINE void bench_cmp_symbolic_register__cmp_indirect_auto_indexed(void) {
  uint16_t dst = 0x1234;
  uint16_t* psrc = BASE_PTR;
...
INLINE void bench_cmp_symbolic_register__cmp_indirect_auto_symbolic(void) {
  uint16_t dst = 0x1234;
  uint16_t* psrc = BASE_PTR;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
...
INLINE void bench_cmp_symbolic_register__cmp_indirect_auto_absolute(void) {
  uint16_t dst = 0x1234;
  uint16_t* psrc = BASE_PTR;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
...
int main(void) {
  ...
  BENCH(bench_cmp_symbolic_register__cmp_indirect_absolute());
  BENCH(bench_cmp_symbolic_register__cmp_indirect_auto_register());
  BENCH(bench_cmp_symbolic_register__cmp_indirect_auto_indexed());
  BENCH(bench_cmp_symbolic_register__cmp_indirect_auto_symbolic());
  BENCH(bench_cmp_symbolic_register__cmp_indirect_auto_absolute());
