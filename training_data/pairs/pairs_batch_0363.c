...
INLINE void bench_mov_indirect_auto_register__cmp_indirect_absolute(void) {
...
INLINE void bench_mov_indirect_auto_register__cmp_indirect_auto_indexed(void) {
  uint16_t* psrc = BASE_PTR;
  uint16_t dst = 0x1234;
...
INLINE void bench_mov_indirect_auto_register__cmp_indirect_auto_symbolic(void) {
  uint16_t* psrc = BASE_PTR;
  uint16_t dst = 0x1234;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
...
INLINE void bench_mov_indirect_auto_register__cmp_indirect_auto_absolute(void) {
  uint16_t* psrc = BASE_PTR;
  uint16_t dst = 0x1234;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
...
int main(void) {
  ...
  BENCH(bench_mov_indirect_auto_register__cmp_indirect_absolute());
  BENCH(bench_mov_indirect_auto_register__cmp_indirect_auto_register());
  BENCH(bench_mov_indirect_auto_register__cmp_indirect_auto_indexed());
  BENCH(bench_mov_indirect_auto_register__cmp_indirect_auto_symbolic());
  BENCH(bench_mov_indirect_auto_register__cmp_indirect_auto_absolute());
