...
INLINE void bench_mov_indirect_auto_indexed__mov_indirect_auto_symbolic(void) {
  uint16_t* psrc = BASE_PTR;
...
INLINE void bench_mov_indirect_auto_indexed__mov_indirect_auto_absolute(void) {
  uint16_t* psrc = BASE_PTR;
  uint16_t* base_dst = BASE_PTR + 8;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
...
INLINE void bench_mov_indirect_auto_indexed__cmp_register_register(void) {
  uint16_t* psrc = BASE_PTR;
  uint16_t* base_dst = BASE_PTR + 8;
  uint16_t src = 0x5678;
  uint16_t dst = 0x1234;
...
INLINE void bench_mov_indirect_auto_indexed__cmp_register_indexed(void) {
  uint16_t* psrc = BASE_PTR;
  uint16_t* base_dst = BASE_PTR + 8;
  uint16_t src = 0x5678;
  REPEAT_INNER_ITERS(__asm__ volatile(
...
INLINE void bench_mov_indirect_auto_indexed__cmp_register_symbolic(void) {
  uint16_t* psrc = BASE_PTR;
  uint16_t* base_dst = BASE_PTR + 8;
  uint16_t src = 0x5678;
  REPEAT_INNER_ITERS(__asm__ volatile(
...
int main(void) {
  ...
  BENCH(bench_mov_indirect_auto_indexed__mov_indirect_auto_symbolic());
  BENCH(bench_mov_indirect_auto_indexed__mov_indirect_auto_absolute());
  BENCH(bench_mov_indirect_auto_indexed__cmp_register_register());
  BENCH(bench_mov_indirect_auto_indexed__cmp_register_indexed());
  BENCH(bench_mov_indirect_auto_indexed__cmp_register_symbolic());
