...
INLINE void bench_add_indexed_register__cmp_indirect_absolute(void) {
...
INLINE void bench_add_indexed_register__cmp_indirect_auto_indexed(void) {
  uint16_t* base_src = BASE_PTR;
  uint16_t dst = 0x1234;
  uint16_t* psrc = BASE_PTR;
...
INLINE void bench_add_indexed_register__cmp_indirect_auto_symbolic(void) {
  uint16_t* base_src = BASE_PTR;
  uint16_t dst = 0x1234;
  uint16_t* psrc = BASE_PTR;
  REPEAT_INNER_ITERS(__asm__ volatile(
...
INLINE void bench_add_indexed_register__cmp_indirect_auto_absolute(void) {
  uint16_t* base_src = BASE_PTR;
  uint16_t dst = 0x1234;
  uint16_t* psrc = BASE_PTR;
  REPEAT_INNER_ITERS(__asm__ volatile(
...
int main(void) {
  ...
  BENCH(bench_add_indexed_register__cmp_indirect_absolute());
  BENCH(bench_add_indexed_register__cmp_indirect_auto_register());
  BENCH(bench_add_indexed_register__cmp_indirect_auto_indexed());
  BENCH(bench_add_indexed_register__cmp_indirect_auto_symbolic());
  BENCH(bench_add_indexed_register__cmp_indirect_auto_absolute());
