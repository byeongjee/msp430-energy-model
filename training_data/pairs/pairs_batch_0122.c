...
INLINE void bench_add_symbolic_indexed__add_symbolic_symbolic(void) {
...
INLINE void bench_add_symbolic_indexed__add_symbolic_absolute(void) {
  uint16_t* base_dst = BASE_PTR + 8;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  add.w sym_data, %c[offs_dst](%[base_dst])\n"
...
INLINE void bench_add_symbolic_indexed__add_absolute_register(void) {
  uint16_t* base_dst = BASE_PTR + 8;
  uint16_t dst = 0x1234;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
...
INLINE void bench_add_symbolic_indexed__add_absolute_indexed(void) {
  uint16_t* base_dst = BASE_PTR + 8;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  add.w sym_data, %c[offs_dst](%[base_dst])\n"
...
INLINE void bench_add_symbolic_indexed__add_absolute_symbolic(void) {
  uint16_t* base_dst = BASE_PTR + 8;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  add.w sym_data, %c[offs_dst](%[base_dst])\n"
...
int main(void) {
  ...
  BENCH(bench_add_symbolic_indexed__add_symbolic_symbolic());
  BENCH(bench_add_symbolic_indexed__add_symbolic_absolute());
  BENCH(bench_add_symbolic_indexed__add_absolute_register());
  BENCH(bench_add_symbolic_indexed__add_absolute_indexed());
  BENCH(bench_add_symbolic_indexed__add_absolute_symbolic());
