...
INLINE void bench_mov_symbolic_indexed(void) {
  ...
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  mov.w sym_data, %c[dst_offs](%[dst_base])\n"
      ".endr\n"
      : 
...
INLINE void bench_mov_absolute_symbolic(void) {
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  mov.w &sym_data, sym_data\n"
      ".endr\n"
...
INLINE void bench_mov_indirect_indexed(void) {
  ...
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  mov.w @%[psrc], %c[dst_offs](%[dst_base])\n"
      ".endr\n"
      : 
...
INLINE void bench_mov_indirect_symbolic(void) {
  uint16_t* psrc = BASE_PTR;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  mov.w @%[psrc], sym_data\n"
...
INLINE void bench_mov_indirect_auto_register(void) {
  uint16_t dst = 0x1234;
  uint16_t* psrc = BASE_PTR;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
...
INLINE void bench_mov_indirect_auto_indexed(void) {
  uint16_t* dst_base = BASE_PTR;
  uint16_t* psrc = BASE_PTR;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
...
INLINE void bench_mov_indirect_auto_symbolic(void) {
  uint16_t* psrc = BASE_PTR;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  mov.w @%[psrc]+, sym_data\n"
...
INLINE void bench_mov_indirect_auto_absolute(void) {
  uint16_t* psrc = BASE_PTR;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  mov.w @%[psrc]+, &sym_data\n"
...
INLINE void bench_cmp_register_symbolic(void) {
  uint16_t src = 0x5678;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  cmp.w %[src], sym_data\n"
...
INLINE void bench_cmp_register_absolute(void) {
  uint16_t src = 0x5678;
  REPEAT_INNER_ITERS(__asm__ volatile(
      ".rept " STR(TEXTUAL_REPT) "\n"
      "  cmp.w %[src], &sym_data\n"
...
int main(void) {
  ...
  BENCH(bench_mov_absolute_symbolic());
  BENCH(bench_mov_absolute_absolute());
  BENCH(bench_mov_indirect_register());
  BENCH(bench_mov_indirect_indexed());
  BENCH(bench_mov_indirect_symbolic());
  BENCH(bench_mov_indirect_absolute());
  BENCH(bench_mov_indirect_auto_register());
  BENCH(bench_mov_indirect_auto_indexed());
  BENCH(bench_mov_indirect_auto_symbolic());
  BENCH(bench_mov_indirect_auto_absolute());
  BENCH(bench_cmp_register_register());
  BENCH(bench_cmp_register_indexed());
  BENCH(bench_cmp_register_symbolic());
  BENCH(bench_cmp_register_absolute());
